...
class Source:
	...
	#def __init__(self, name):
		...
		self.port=port;
		self.value="Kepco 1"
		k=serial.Serial(self.port,baudrate=9600, bytesize=serial.EIGHTBITS, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, timeout=None, xonxoff=True, rtscts=False, write_timeout=0.5, dsrdtr=False, inter_byte_timeout=None);
