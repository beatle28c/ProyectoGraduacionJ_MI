...
def main():
	...
	sin.activate()
	Harm = Button(win, Point(refx,refy-3), width_b, heigh_b, "Harmonicas")
	Harm.activate()
	trian = Button(win, Point(refx,refy-6), width_b, heigh_b, "Triangular")
	trian.activate()
	#meas = Button(win, Point(refx,refy-6), width_b, heigh_b, "Medir V1")
	#meas.activate()
	info = Button(win, Point(refx,refy-9), width_b, heigh_b, "info")
	info.activate()
	stop = Button(win, Point(refx,refy-12), width_b, heigh_b, "Stop")
	stop.activate()
	...
	#meas2.activate()
	info2 = Button(win, Point(refx2,refy-9), width_b, heigh_b, "info")
	info2.activate()
	stop2 = Button(win, Point(refx2,refy-12), width_b, heigh_b, "Stop")
	stop2.activate()
	...
	port2_val.setText('USB1')
	port2_val.draw(win)
	
	#'/dev/ttyUSB0'
	
		################## Mensaje de lectura ##################
	mensaje=Text(Point(5,5.5),"")
